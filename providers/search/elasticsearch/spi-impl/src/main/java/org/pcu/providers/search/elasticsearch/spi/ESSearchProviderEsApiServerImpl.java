 ...
 *
 */
@Path("/search/esapi") // TODO Q or /searchcpt, /data, /nosql ?? can be extended on client side, and overloaded by impl (whose value should ONLY be "/" else blocks UI servlet)
...
public class ESSearchProviderEsApiServerImpl extends PcuJaxrsServerBase implements PcuSearchEsApi {
   ...
   public ESSearchProviderEsApiServerImpl() {
