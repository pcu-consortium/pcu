...
@ContextConfiguration(classes={PcuSearchSimpleConfiguration.class,ESSearchProviderConfiguration.class},
...
@ActiveProfiles("test")
public class PcuSearchApiSimpleImplTest /*extends PcuSearchApiClientTest */{
   @LocalServerPort
