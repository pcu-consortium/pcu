 ...
 */
@Configuration
@ComponentScan(basePackageClasses={PcuSearchServerConfiguration.class, PcuSearchApiClientConfiguration.class})
...
public class PcuSearchServerConfiguration {
    ...
    @Bean
    public Server pcuSearchRsServer(SpringBus bus, JacksonJsonProvider pcuSearchApiJsonProvider,
          PcuSearchApi pcuSearchApiImpl/*, PcuApiExceptionMapper pcuApiExceptionMapper,
          PcuApiSwagger2Feature pcuApiSwagger2Feature*/) {
        ArrayList<Object> providers = new ArrayList<Object>();
        providers.add(pcuSearchApiImpl);
        ...
        endpoint.setBus(bus);
        endpoint.setAddress("/");
        endpoint.setServiceBean(pcuSearchApiImpl);
